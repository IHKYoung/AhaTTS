...
async def phonemize_text(request: PhonemeRequest) -> PhonemeResponse:
    """Convert text to phonemes using AhaTTS quiet mode.
    ...
    try:
        ...
        # Initialize AhaTTS pipeline in quiet mode (no model)
...
async def generate_from_phonemes(
    ...
    """Generate audio directly from phonemes using AhaTTS phoneme format"""
    try:
        # Basic validation
