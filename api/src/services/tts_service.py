...
class TTSService:
    ...
    async def _process_chunk(
        ...
        is_first: bool = False,
        is_last: bool = False,
        volume_multiplier: float | None = 1.0,
        normalizer: AudioNormalizer | None = None,
        lang_code: str | None = None,
        return_timestamps: bool | None = False,
        ...
        async with self._chunk_semaphore:
            try:
                ...
                if isinstance(backend, KokoroV1):
                    chunk_index = 0
                    # For AhaTTS V1, pass text and voice info with lang_code
    ...
    async def generate_audio_stream(
        ...
        lang_code: str | None = None,
        volume_multiplier: float | None = 1.0,
        normalization_options: NormalizationOptions | None = NormalizationOptions(),
        return_timestamps: bool | None = False,
    ) -> AsyncGenerator[AudioChunk, None]:
                ...
                if pause_duration_s is not None and pause_duration_s > 0:
                    ...
                    try:
                        ...
                        async for chunk_data in self._process_chunk(
                            chunk_text,  # Pass text for AhaTTS V1
    ...
    async def generate_from_phonemes(
        ...
        Args:
            phonemes: Phonemes in AhaTTS format
            voice: Voice name
        ...
        try:
            ...
            if isinstance(backend, KokoroV1):
                # For AhaTTS V1, use generate_from_tokens with raw phonemes
                result = None
                # Use provided lang_code or determine from voice name
                pipeline_lang_code = lang_code if lang_code else voice[:1].lower()
                logger.info(
                ...
                raise ValueError(
                    "Phoneme generation only supported with AhaTTS V1 backend"
                )
