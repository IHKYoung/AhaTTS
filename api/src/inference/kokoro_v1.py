"""Clean AhaTTS implementation with controlled resource management."""
...
class KokoroV1(BaseModelBackend):
    """AhaTTS backend with controlled resource management."""
    ...
    async def load_model(self, path: str) -> None:
        ...
        try:
            ...
            logger.info(f"Loading AhaTTS model on {self._device}")
            ...
            raise RuntimeError(f"Failed to load AhaTTS model: {e}")
    ...
    async def generate_from_tokens(
        self,
        tokens: str,
        voice: str | tuple[str, torch.Tensor | str],
        speed: float = 1.0,
