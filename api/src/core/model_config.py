"""Model configuration for AhaTTS V1.
...
class ModelConfig(BaseModel):
    ...
    pytorch_kokoro_v1_file: str = Field(
        "v1_0/kokoro-v1_0.pth", description="PyTorch AhaTTS V1 model filename"
    )
