...
class Settings(BaseSettings):
    # API Settings
    api_title: str = "AhaTTS API"
    api_description: str = "API for text-to-speech generation using AhaTTS"
    ...
    enable_web_ui: bool = True  # Whether to serve the bundled web UI

    # Container absolute paths
    model_dir: str = "/app/api/src/models"  # Absolute path in container
    voices_dir: str = "/app/api/src/voices/v1_0"  # Absolute path in container
    web_player_path: str = "api/web"  # Path to bundled web UI (project-root relative)
